...
export const UI_ROLE_EQUIP_DETAIL_BG = `${ROLE_UI_ROOT}/role_equip_replace_drawer_bg`;
export const UI_ROLE_EQUIP_DETAIL_TITLE_BG = `${ROLE_UI_ROOT}/role_small_title_bg`;
...
export const BAG_GRID_CELL_SIZE = 120;
export const BAG_GRID_FRAME_SIZE = 118;
export const BAG_GRID_ICON_SIZE = 92;
export const BAG_GRID_ICON_OFFSET_Y = 4;
export const BAG_GRID_COUNT_FONT_SIZE = 25;
export const BAG_GRID_COUNT_WIDTH = 92;
export const BAG_GRID_COUNT_HEIGHT = 35;
export const BAG_GRID_COUNT_X = 35;
export const BAG_GRID_COUNT_Y = -39;
export const BAG_GRID_CELL_GAP_X = 16;
export const BAG_GRID_CELL_GAP_Y = 18;
