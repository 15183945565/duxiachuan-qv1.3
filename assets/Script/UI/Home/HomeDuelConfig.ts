...
export const DUEL_LUANSHI_ZHENGXIONG_BGM_PATH = 'Audio/Duel/duel_luanshi_zhengxiong_bgm';
export const DUEL_LUANSHI_NORMAL_ATTACK_AUDIO_PATH = 'Audio/Duel/duel_luanshi_normal_attack';
export const DUEL_LUANSHI_SUCCESS_AUDIO_PATH = 'Audio/Duel/duel_luanshi_success';
export const DUEL_LUANSHI_FAILURE_AUDIO_PATH = 'Audio/Duel/duel_luanshi_failure';
export const DUEL_LUANSHI_SKILL_AUDIO_ROOT = 'Audio/Duel/LuanshiSkill';
export const DUEL_LUANSHI_SKILL_WANJIAN_JIDI_AUDIO_PATH = `${DUEL_LUANSHI_SKILL_AUDIO_ROOT}/skill_wanjian_jidi`;
export const DUEL_LUANSHI_SKILL_BINGJIAN_AUDIO_PATH = `${DUEL_LUANSHI_SKILL_AUDIO_ROOT}/skill_bingjian`;
export const DUEL_LUANSHI_SKILL_DIAOZHONG_AUDIO_PATH = `${DUEL_LUANSHI_SKILL_AUDIO_ROOT}/skill_diaozhong`;
export const DUEL_LUANSHI_SKILL_TAIJI_AUDIO_PATH = `${DUEL_LUANSHI_SKILL_AUDIO_ROOT}/skill_taiji`;
export const DUEL_LUANSHI_SKILL_GUAISHOU_MENGCHONG_AUDIO_PATH = `${DUEL_LUANSHI_SKILL_AUDIO_ROOT}/skill_guaishou_mengchong`;
export const DUEL_LUANSHI_SKILL_HUOYAN_DOWN_AUDIO_PATH = `${DUEL_LUANSHI_SKILL_AUDIO_ROOT}/skill_huoyan_down`;
export const DUEL_LUANSHI_SKILL_HONGJIAN_AUDIO_PATH = `${DUEL_LUANSHI_SKILL_AUDIO_ROOT}/skill_hongjian`;
export const DUEL_LUANSHI_SKILL_LANSE_MOFA_AUDIO_PATH = `${DUEL_LUANSHI_SKILL_AUDIO_ROOT}/skill_lanse_mofa`;
export const DUEL_LUANSHI_SKILL_ULTIMATE_1_AUDIO_PATH = `${DUEL_LUANSHI_SKILL_AUDIO_ROOT}/skill_ultimate_1`;
export const DUEL_LUANSHI_SKILL_ULTIMATE_2_AUDIO_PATH = `${DUEL_LUANSHI_SKILL_AUDIO_ROOT}/skill_ultimate_2`;
...
export const DUEL_LUANSHI_SKILL_CONFIGS = [
    { id: 'wanjian_jidi', label: '\u4e07\u5251\u51fb\u5730', yuanbaoCost: DUEL_LUANSHI_SKILL_COST_YUANBAO, iconPath: `${DUEL_LUANSHI_SKILL_ICON_UI_ROOT}/skill_wanjian_jidi`, frameEffectPaths: DUEL_LUANSHI_SKILL_ICON_EFFECT_FRAME_PATHS.wanjian_jidi, spinePath: `${DUEL_LUANSHI_SPINE_ROOT}/wanjian_jidi/specialAtk147003-1`, audioPath: DUEL_LUANSHI_SKILL_WANJIAN_JIDI_AUDIO_PATH, audioDelaySeconds: 0 },
    { id: 'bingjian', label: '\u51b0\u5251', yuanbaoCost: DUEL_LUANSHI_SKILL_COST_YUANBAO, iconPath: `${DUEL_LUANSHI_SKILL_ICON_UI_ROOT}/skill_bingjian`, frameEffectPaths: DUEL_LUANSHI_SKILL_ICON_EFFECT_FRAME_PATHS.bingjian, spinePath: `${DUEL_LUANSHI_SPINE_ROOT}/bingjian/magicSkill1403`, audioPath: DUEL_LUANSHI_SKILL_BINGJIAN_AUDIO_PATH, audioDelaySeconds: 0.3 },
    { id: 'diaozhong', label: '\u540a\u949f', yuanbaoCost: DUEL_LUANSHI_SKILL_COST_YUANBAO, iconPath: `${DUEL_LUANSHI_SKILL_ICON_UI_ROOT}/skill_diaozhong`, frameEffectPaths: DUEL_LUANSHI_SKILL_ICON_EFFECT_FRAME_PATHS.diaozhong, spinePath: `${DUEL_LUANSHI_SPINE_ROOT}/diaozhong/magicSkill1301`, audioPath: DUEL_LUANSHI_SKILL_DIAOZHONG_AUDIO_PATH, audioDelaySeconds: 0 },
    { id: 'taiji', label: '\u592a\u6781', yuanbaoCost: DUEL_LUANSHI_SKILL_COST_YUANBAO, frameEffectSize: 150, iconPath: `${DUEL_LUANSHI_SKILL_ICON_UI_ROOT}/skill_taiji`, frameEffectPaths: DUEL_LUANSHI_SKILL_ICON_EFFECT_FRAME_PATHS.taiji, spinePath: `${DUEL_LUANSHI_SPINE_ROOT}/taiji/magicSkill1406`, audioPath: DUEL_LUANSHI_SKILL_TAIJI_AUDIO_PATH, audioDelaySeconds: 0 },
    { id: 'guaishou_mengchong', label: '\u602a\u517d\u731b\u51b2', yuanbaoCost: DUEL_LUANSHI_SKILL_COST_YUANBAO, frameEffectSize: 170, iconPath: `${DUEL_LUANSHI_SKILL_ICON_UI_ROOT}/skill_guaishou_mengchong`, frameEffectPaths: DUEL_LUANSHI_SKILL_ICON_EFFECT_FRAME_PATHS.guaishou_mengchong, spinePath: `${DUEL_LUANSHI_SPINE_ROOT}/guaishou_mengchong/magicSkill1404`, audioPath: DUEL_LUANSHI_SKILL_GUAISHOU_MENGCHONG_AUDIO_PATH, audioDelaySeconds: 0 },
    { id: 'huoyan_down', label: '\u706b\u7130\u4e0b\u5288', yuanbaoCost: DUEL_LUANSHI_SKILL_COST_YUANBAO, iconPath: `${DUEL_LUANSHI_SKILL_ICON_UI_ROOT}/skill_huoyan_down`, frameEffectPaths: DUEL_LUANSHI_SKILL_ICON_EFFECT_FRAME_PATHS.huoyan_down, spinePath: `${DUEL_LUANSHI_SPINE_ROOT}/huoyan_down/H043_Special`, audioPath: DUEL_LUANSHI_SKILL_HUOYAN_DOWN_AUDIO_PATH, audioDelaySeconds: 0.3 },
    { id: 'hongjian', label: '\u7ea2\u5251', yuanbaoCost: DUEL_LUANSHI_SKILL_COST_YUANBAO, iconPath: `${DUEL_LUANSHI_SKILL_ICON_UI_ROOT}/skill_hongjian`, frameEffectPaths: DUEL_LUANSHI_SKILL_ICON_EFFECT_FRAME_PATHS.hongjian, spinePath: `${DUEL_LUANSHI_SPINE_ROOT}/hongjian/magicSkill1201`, audioPath: DUEL_LUANSHI_SKILL_HONGJIAN_AUDIO_PATH, audioDelaySeconds: 0 },
    { id: 'lanse_mofa', label: '\u84dd\u8272\u9b54\u6cd5', yuanbaoCost: DUEL_LUANSHI_SKILL_COST_YUANBAO, frameEffectSize: 160, iconPath: `${DUEL_LUANSHI_SKILL_ICON_UI_ROOT}/skill_lanse_mofa`, frameEffectPaths: DUEL_LUANSHI_SKILL_ICON_EFFECT_FRAME_PATHS.lanse_mofa, spinePath: `${DUEL_LUANSHI_SPINE_ROOT}/lanse_mofa/H041_Special`, audioPath: DUEL_LUANSHI_SKILL_LANSE_MOFA_AUDIO_PATH, audioDelaySeconds: 0 },
    { id: 'ultimate_1', label: '\u5927\u62db\u6280\u80fd1', yuanbaoCost: DUEL_LUANSHI_SKILL_COST_YUANBAO, frameEffectSize: 150, iconPath: `${DUEL_LUANSHI_SKILL_ICON_UI_ROOT}/skill_ultimate_1`, frameEffectPaths: DUEL_LUANSHI_SKILL_ICON_EFFECT_FRAME_PATHS.ultimate_1, spinePath: `${DUEL_LUANSHI_SPINE_ROOT}/ultimate_1/action`, fullScreenEffect: true, flipFullScreenForGaibang: true, effectScale: 2.75, fullScreenOffsetY: 0, audioPath: DUEL_LUANSHI_SKILL_ULTIMATE_1_AUDIO_PATH, audioDelaySeconds: 1 },
    { id: 'ultimate_2', label: '\u5927\u62db\u6280\u80fd2', yuanbaoCost: DUEL_LUANSHI_SKILL_COST_YUANBAO, frameEffectSize: 150, iconPath: `${DUEL_LUANSHI_SKILL_ICON_UI_ROOT}/skill_ultimate_2`, frameEffectPaths: DUEL_LUANSHI_SKILL_ICON_EFFECT_FRAME_PATHS.ultimate_2, spinePath: `${DUEL_LUANSHI_SPINE_ROOT}/ultimate_2/action`, fullScreenEffect: true, effectScale: 2.05, fullScreenOffsetY: -45, audioPath: DUEL_LUANSHI_SKILL_ULTIMATE_2_AUDIO_PATH, audioDelaySeconds: 0 },
] as const;
