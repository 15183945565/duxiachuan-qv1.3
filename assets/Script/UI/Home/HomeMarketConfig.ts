...
export const MARKET_SELL_VIEWPORT_HEIGHT = 1086.385;
export const MARKET_SELL_VIEWPORT_Y = -37.9665;
export const MARKET_SELL_CONTENT_Y = -31.2595;
export const MARKET_HISTORY_VIEWPORT_HEIGHT = MARKET_SELL_VIEWPORT_HEIGHT;
export const MARKET_HISTORY_VIEWPORT_Y = MARKET_SELL_VIEWPORT_Y;
...
export const MARKET_SELL_ADD_SLOT_WIDTH = 626;
export const MARKET_SELL_ADD_SLOT_HEIGHT = 150;
export const MARKET_SELL_ADD_SLOT_Y = 488.868;
export const MARKET_SELL_ADD_BUTTON_SIZE = 58;
export const MARKET_SELL_ADD_BUTTON_Y = -12;
...
export const MARKET_POST_EXPIRE_DURATION_MS = 2 * 24 * 60 * 60 * 1000;
export const MARKET_SELL_CONFIRM_BOARD_WIDTH = 640;
export const MARKET_SELL_CONFIRM_BOARD_HEIGHT = 640;
export const MARKET_SELL_CONFIRM_BOARD_SCALE = 1.1;
export const MARKET_SELL_CONFIRM_TITLE_SKIN_ACTIVE = true;
export const MARKET_SELL_CONFIRM_TITLE_SKIN_WIDTH = 300;
export const MARKET_SELL_CONFIRM_TITLE_SKIN_HEIGHT = 64;
export const MARKET_SELL_CONFIRM_TITLE_SKIN_Y = 230;
export const MARKET_SELL_CONFIRM_TITLE_WIDTH = 280;
export const MARKET_SELL_CONFIRM_TITLE_HEIGHT = 52;
export const MARKET_SELL_CONFIRM_TITLE_Y = 230;
export const MARKET_SELL_CONFIRM_FRAME_Y = 146.5;
export const MARKET_SELL_CONFIRM_ICON_Y = 148;
export const MARKET_SELL_CONFIRM_TYPE_X = 0;
export const MARKET_SELL_CONFIRM_TYPE_Y = 65;
export const MARKET_SELL_CONFIRM_TYPE_WIDTH = 600;
export const MARKET_SELL_CONFIRM_TYPE_HEIGHT = 30;
export const MARKET_SELL_CONFIRM_PRICE_RANGE_X = 0;
export const MARKET_SELL_CONFIRM_PRICE_RANGE_Y = 25.01;
export const MARKET_SELL_CONFIRM_PRICE_RANGE_WIDTH = 520;
export const MARKET_SELL_CONFIRM_PRICE_RANGE_HEIGHT = 30;
export const MARKET_SELL_CONFIRM_QUANTITY_ROW = {
    titleX: -190,
    y: -28,
    minusX: -112,
    bgX: 0,
...
export const MARKET_SELL_CONFIRM_UNIT_PRICE_ROW = {
    titleX: -188.678,
    y: -86.51,
    minusX: -110.678,
    bgX: 1.322,
...
export const MARKET_SELL_CONFIRM_INCOME_CAPTION_X = -82.505;
export const MARKET_SELL_CONFIRM_INCOME_CAPTION_Y = -136.999;
export const MARKET_SELL_CONFIRM_INCOME_VALUE_X = 86.596;
export const MARKET_SELL_CONFIRM_INCOME_VALUE_Y = -136.999;
export const MARKET_SELL_CONFIRM_FEE_PREFIX_X = -72.041;
export const MARKET_SELL_CONFIRM_FEE_PREFIX_Y = -166.74;
export const MARKET_SELL_CONFIRM_FEE_RATE_X = 31;
export const MARKET_SELL_CONFIRM_FEE_RATE_Y = -167.013;
export const MARKET_SELL_CONFIRM_FEE_SUFFIX_X = 100.086;
export const MARKET_SELL_CONFIRM_FEE_SUFFIX_Y = -167.013;
export const MARKET_SELL_CONFIRM_CANCEL_X = -115.247;
export const MARKET_SELL_CONFIRM_CANCEL_Y = -212.481;
export const MARKET_SELL_CONFIRM_SUBMIT_X = 112;
export const MARKET_SELL_CONFIRM_SUBMIT_Y = -212.481;
export const MARKET_HISTORY_CONTENT_Y = 2.367;
export const MARKET_HISTORY_ROW_HEIGHT = 88;
export const MARKET_HISTORY_ROW_GAP = 14;
export const MARKET_HISTORY_ROW_STEP = MARKET_HISTORY_ROW_HEIGHT + MARKET_HISTORY_ROW_GAP;
export const MARKET_HISTORY_ROW_TOP_PADDING = 18;
export const MARKET_HISTORY_RICH_TEXT_WIDTH = 610;
export const MARKET_HISTORY_RICH_TEXT_HEIGHT = 56;
export const MARKET_HISTORY_RICH_TEXT_Y = 10;
export const MARKET_HISTORY_RICH_TEXT_FONT_SIZE = 25;
export const MARKET_HISTORY_RICH_TEXT_LINE_HEIGHT = 34;
export const MARKET_HISTORY_DIVIDER_WIDTH = 610;
export const MARKET_HISTORY_DIVIDER_HEIGHT = 4;
export const MARKET_HISTORY_DIVIDER_Y = -35;
