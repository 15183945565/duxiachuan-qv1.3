...
export const UI_MAGIC_FLOOR_ENTER_POPUP_BG = `${MAGIC_UI_ROOT}/magic_floor_enter_popup_bg`;
...
export const MAGIC_FLOOR_ENTER_POPUP_WIDTH = 590;
export const MAGIC_FLOOR_ENTER_POPUP_HEIGHT = 624;
export const MAGIC_FLOOR_ENTER_TITLE_WIDTH = 230;
export const MAGIC_FLOOR_ENTER_TITLE_HEIGHT = 60;
export const MAGIC_FLOOR_ENTER_TITLE_Y = 237;
export const MAGIC_FLOOR_ENTER_TITLE_LABEL_WIDTH = 210;
export const MAGIC_FLOOR_ENTER_TITLE_LABEL_HEIGHT = 44;
export const MAGIC_FLOOR_ENTER_TITLE_FONT_SIZE = 27;
export const MAGIC_FLOOR_ENTER_INFO_ROOT_WIDTH = 488;
export const MAGIC_FLOOR_ENTER_INFO_ROOT_HEIGHT = 162;
export const MAGIC_FLOOR_ENTER_INFO_ROOT_Y = 121;
export const MAGIC_FLOOR_ENTER_SECTION_LABEL_X = -206;
export const MAGIC_FLOOR_ENTER_SECTION_LABEL_WIDTH = 170;
export const MAGIC_FLOOR_ENTER_SECTION_LABEL_HEIGHT = 30;
export const MAGIC_FLOOR_ENTER_SECTION_FONT_SIZE = 22;
export const MAGIC_FLOOR_ENTER_INFO_ROW_X = -76.338;
export const MAGIC_FLOOR_ENTER_INFO_ROW_WIDTH = 390;
export const MAGIC_FLOOR_ENTER_INFO_ROW_HEIGHT = 30;
export const MAGIC_FLOOR_ENTER_INFO_ROW_FONT_SIZE = 21;
export const MAGIC_FLOOR_ENTER_INFO_ROW_START_Y = 36.823;
export const MAGIC_FLOOR_ENTER_INFO_ROW_GAP = 30;
export const MAGIC_FLOOR_ENTER_MATERIAL_ROOT_WIDTH = 500;
export const MAGIC_FLOOR_ENTER_MATERIAL_ROOT_HEIGHT = 230;
export const MAGIC_FLOOR_ENTER_MATERIAL_ROOT_Y = -72;
export const MAGIC_FLOOR_ENTER_MATERIAL_TITLE_Y = 87;
export const MAGIC_FLOOR_ENTER_MATERIAL_ITEM_WIDTH = 120;
export const MAGIC_FLOOR_ENTER_MATERIAL_ITEM_HEIGHT = 98;
export const MAGIC_FLOOR_ENTER_MATERIAL_COLUMN_GAP = 150;
export const MAGIC_FLOOR_ENTER_MATERIAL_SINGLE_ROW_GAP = 82;
export const MAGIC_FLOOR_ENTER_MATERIAL_SINGLE_ROW_Y = 24;
export const MAGIC_FLOOR_ENTER_MATERIAL_ROW_GAP = 96;
export const MAGIC_FLOOR_ENTER_MATERIAL_FRAME_SIZE = 64;
export const MAGIC_FLOOR_ENTER_MATERIAL_ICON_SIZE = 44;
export const MAGIC_FLOOR_ENTER_MATERIAL_ICON_Y = 10;
export const MAGIC_FLOOR_ENTER_MATERIAL_COUNT_Y = -40;
export const MAGIC_FLOOR_ENTER_MATERIAL_COUNT_WIDTH = 104;
export const MAGIC_FLOOR_ENTER_MATERIAL_COUNT_HEIGHT = 26;
export const MAGIC_FLOOR_ENTER_MATERIAL_COUNT_FONT_SIZE = 18;
export const MAGIC_FLOOR_ENTER_DAILY_ROOT_Y = -196;
export const MAGIC_FLOOR_ENTER_BUTTON_Y = -258;
export const MAGIC_FLOOR_ENTER_CANCEL_BUTTON_X = -106;
export const MAGIC_FLOOR_ENTER_ACCEPT_BUTTON_X = 106;
export const MAGIC_FLOOR_REQUIREMENT_MATERIAL_IDS = ['material_097', 'material_093', 'material_094', 'material_095', 'material_096'] as const;
export const MAGIC_FLOOR_REQUIREMENT_MATERIAL_COSTS = [2, 2, 2, 2, 2] as const;
